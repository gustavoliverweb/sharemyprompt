...
export function RegisterHero() {
  return (
    <div className="hidden lg:flex relative overflow-hidden bg-surface items-end p-16 ">
      {/* Background glows */}
      ...
      {/* Tagline */}
      <Image
        src="/images/login/singup-img2.png"
        alt="Register Hero"
        width={650}
        height={500}
      ...
      <div className="relative z-10 ">
        <p className="text-[40px] xl:text-[39px] font-bold text-white leading-[1.15] tracking-tight">
          Únete a la élite que domina la IA mediante el diseño de los prompts y
          agentes más avanzados del mercado.
        </p>
      </div>
    </div>
  );
